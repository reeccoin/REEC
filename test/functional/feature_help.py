...
"""Verify that starting reeccoin with -h works as expected."""
import subprocess

from test_framework.test_framework import ReeccoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ReeccoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reeccoin with -? for help text")
        ...
        self.log.info("Start reeccoin with -version for version information")
