...
#ifndef REECCOIN_ZREECWALLET_H
#define REECCOIN_ZREECWALLET_H
...
public:
    ...
    void GenerateDeterministicZREEC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZREEC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
