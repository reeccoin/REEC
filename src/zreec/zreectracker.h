...
#ifndef REECCOIN_ZREECTRACKER_H
#define REECCOIN_ZREECTRACKER_H
...
public:
    CzREECTracker(CWallet* parent);
    ~CzREECTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzREECWallet* zREECWallet = NULL);
