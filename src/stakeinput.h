...
#ifndef REECCOIN_STAKEINPUT_H
#define REECCOIN_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZREEC() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CReecStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZREEC() const override { return false; }
