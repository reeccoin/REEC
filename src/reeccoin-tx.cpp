...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Reeccoin Core reeccoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  reeccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded reeccoin transaction") + "\n" +
                               "  reeccoin-tx [options] -create [commands]   " + _("Create hex-encoded reeccoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded reeccoin transaction
