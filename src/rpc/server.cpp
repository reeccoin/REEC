...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop REECCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "REECCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"reeccoin", "listmasternodes", &listmasternodes, true },
        {"reeccoin", "getmasternodecount", &getmasternodecount, true },
        {"reeccoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"reeccoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"reeccoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"reeccoin", "masternodecurrent", &masternodecurrent, true },
        {"reeccoin", "startmasternode", &startmasternode, true },
        {"reeccoin", "createmasternodekey", &createmasternodekey, true },
        {"reeccoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"reeccoin", "listmasternodeconf", &listmasternodeconf, true },
        {"reeccoin", "getmasternodestatus", &getmasternodestatus, true },
        {"reeccoin", "getmasternodewinners", &getmasternodewinners, true },
        {"reeccoin", "getmasternodescores", &getmasternodescores, true },
        {"reeccoin", "preparebudget", &preparebudget, true },
        {"reeccoin", "submitbudget", &submitbudget, true },
        {"reeccoin", "mnbudgetvote", &mnbudgetvote, true },
        {"reeccoin", "getbudgetvotes", &getbudgetvotes, true },
        {"reeccoin", "getnextsuperblock", &getnextsuperblock, true },
        {"reeccoin", "getbudgetprojection", &getbudgetprojection, true },
        {"reeccoin", "getbudgetinfo", &getbudgetinfo, true },
        {"reeccoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"reeccoin", "mnfinalbudget", &mnfinalbudget, true },
        {"reeccoin", "checkbudgets", &checkbudgets, true },
        {"reeccoin", "mnsync", &mnsync, true },
        {"reeccoin", "spork", &spork, true },
...
{
    return "> reeccoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:62447/\n";
}
