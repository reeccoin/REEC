...
/* Reeccoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "REECCOIN"
#define QAPP_ORG_DOMAIN "reec.io"
#define QAPP_APP_NAME_DEFAULT "REECCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "REECCOIN-Qt-testnet"
