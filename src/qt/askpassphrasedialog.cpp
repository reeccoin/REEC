...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            REECCOINGUI* window = static_cast<REECCOINGUI*>(parentWidget());
...
{
    REECCOINGUI* gui = static_cast<REECCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<REECCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("REECCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your REECs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
