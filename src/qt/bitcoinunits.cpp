...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(REEC);
    unitlist.append(mREEC);
    unitlist.append(uREEC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case REEC:
        return QString("reeccoin");
    case mREEC:
        return QString("mreeccoin");
    case uREEC:
        return QString::fromUtf8("ureeccoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZreec)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZREEC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZREEC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZREEC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZREEC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
