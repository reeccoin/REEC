...
#include "config/reeccoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalReec = 0;
    qint64 totalZreec = 0;
    QList<qreal> valuesReec;
    QList<qreal> valueszReec;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(REECCOINGUI* _window);
    ~DashboardWidget();
