...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, REECCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, REECCOINGUI* gui, double posX = 3);
