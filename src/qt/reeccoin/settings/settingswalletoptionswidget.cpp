...
#include "qt/reeccoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/reeccoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(REECCOINGUI* _window, QWidget *parent) :
