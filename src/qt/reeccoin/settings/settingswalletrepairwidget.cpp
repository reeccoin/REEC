...
#include "qt/reeccoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/reeccoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(REECCOINGUI* _window, QWidget *parent) :
