...
#include "qt/reeccoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(REECCOINGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("REECCOIN_tx_csv_export(*.csv)") : tr("REECCOIN_addresses_csv_export(*.csv)"),
                                        nullptr);
