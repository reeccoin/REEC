...
#include "qt/reeccoin/settings/settingsnetworkwidget.h"
#include "qt/reeccoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/reeccoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(REECCOINGUI* _window, QWidget *parent) :
