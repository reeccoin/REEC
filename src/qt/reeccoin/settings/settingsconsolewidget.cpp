...
#include "qt/reeccoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/reeccoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(REECCOINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the REECCOIN RPC console.") + "<br>" +
