...
#include "qt/reeccoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/reeccoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(REECCOINGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableREEC,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableREEC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableREEC,
    ...
    connect(ui->pushButton_UnspendableREEC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableREEC);});
    ...
    if (parent)
        connect(parent, &REECCOINGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
