...
#include "qt/reeccoin/topbar.h"
#include "qt/reeccoin/forms/ui_topbar.h"
#include "qt/reeccoin/lockunlock.h"
#include "qt/reeccoin/qtutils.h"
#include "qt/reeccoin/receivedialog.h"
#include "qt/reeccoin/loadingdialog.h"
...
TopBar::TopBar(REECCOINGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopReec}, "amount-small-topbar");
    setCssProperty({ui->labelAmountReec}, "amount-topbar");
    setCssProperty({ui->labelPendingReec, ui->labelImmatureReec}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PIV Total
    QString totalReec = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // PIV
    // Top
    ui->labelAmountTopReec->setText(totalReec);
    // Expanded
    ui->labelAmountReec->setText(totalReec);
    ui->labelPendingReec->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureReec->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
