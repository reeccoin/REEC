...
#include "qt/reeccoin/sendcustomfeedialog.h"
#include "qt/reeccoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(REECCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &REECCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
