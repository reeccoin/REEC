...
#include "qt/reeccoin/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/reeccoin/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("62450");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("62448");
    } else {
        ui->lineEditPort->setText("62446");
    }
