...
#include "qt/reeccoin/furabstractlistitemdelegate.h"
#include "qt/reeccoin/txviewholder.h"
#include "qt/reeccoin/tooltipmenu.h"
#include "qt/reeccoin/sendmultirow.h"
#include "qt/reeccoin/coldstakingmodel.h"
#include "qt/reeccoin/contactsdropdown.h"
#include "qt/reeccoin/addressholder.h"
...
public:
    explicit ColdStakingWidget(REECCOINGUI* parent);
    ~ColdStakingWidget();
