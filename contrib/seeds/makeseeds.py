...
def main():
    ...
    # Filter out hosts with multiple reeccoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple reeccoin ports' % (ip_stats(ips)), file=sys.stderr)
