...
RESOURCES += src/qt/reeccoin.qrc src/qt/reeccoin_locale.qrc

TRANSLATIONS += src/qt/locale/reeccoin_bg.ts \
                src/qt/locale/reeccoin_de.ts \
                src/qt/locale/reeccoin_en.ts \
                src/qt/locale/reeccoin_es.ts \
                src/qt/locale/reeccoin_fi.ts \
                src/qt/locale/reeccoin_fr.ts \
                src/qt/locale/reeccoin_it.ts \
                src/qt/locale/reeccoin_ja.ts \
                src/qt/locale/reeccoin_pl.ts \
                src/qt/locale/reeccoin_pt.ts \
                src/qt/locale/reeccoin_ru.ts \
                src/qt/locale/reeccoin_sk.ts \
                src/qt/locale/reeccoin_sv.ts \
                src/qt/locale/reeccoin_vi.ts \
                src/qt/locale/reeccoin_zh_CN.ts \
                src/qt/locale/reeccoin_zh_TW.ts
