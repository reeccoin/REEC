...
The script [extract-osx-sdk.sh](https://github.com/reeccoin/RECC/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
reeccoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/reeccoin/RECC/blob/master/doc/README_osx.md) for troubleshooting tips.
