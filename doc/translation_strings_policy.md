...
This document provides guidelines for internationalization of the REECCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `reeccoin_en.ts` remains unchanged.
