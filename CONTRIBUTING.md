Contributing to REECCOIN Core
============================

The REECCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/reeccoin/RECC/blob/master/doc/translation_process.md)
...
The following applies to code changes to the REECCOIN Core project, and is not to be
confused with overall REECCOIN Network Protocol consensus changes.

Whether a pull request is merged into REECCOIN Core rests with the project merge
...
Patches that change REECCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the REECCOIN consensus, it must have been
...
The project leader is the release manager for each REECCOIN Core release.
